...
namespace TAO_PEGTL_NAMESPACE::unescape
{
   ...
   struct unescape_u
   {
      ...
      static void apply( const ActionInput& in, std::string& s )
      {
         ...
         IF_( !utf8_append_utf32( s, unhex_string< unsigned >( in.begin() + 1, in.end() ) ) ) {
