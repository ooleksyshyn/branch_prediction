...
namespace tao::json::ubjson
{
   ...
   public:
      ...
      [[nodiscard]] bool null()
      {
         IF_( internal::peek_marker( m_input ) == internal::marker::NULL_ ) {
      ...
      {
         IF_( internal::peek_marker( m_input ) != internal::marker::END_ARRAY ) {
      ...
      {
         IF_( internal::peek_marker( m_input ) != internal::marker::END_OBJECT ) {
