...
#pragma warning( pop )
   ...
   public:
      ...
      [[nodiscard]] bool null()
      {
         IF_( json::internal::peek_uint8( m_input ) == static_cast< std::uint8_t >( internal::major::OTHER ) + 22 ) {
   ...
   private:
      ...
      {
         check_major( m, e );
         IF_( internal::peek_minor_unsafe( m_input ) != internal::minor_mask ) {
   ...
   public:
      ...
      [[nodiscard]] std::string_view string_view()
      {
         ...
         IF_( b != static_cast< std::uint8_t >( internal::major::STRING ) + internal::minor_mask ) {
      ...
      {
         const auto b = json::internal::peek_uint8( m_input );
         IF_( b != static_cast< std::uint8_t >( internal::major::BINARY ) + internal::minor_mask ) {
...
#pragma warning( pop )
   ...
   private:
      ...
      {
         IF_( internal::peek_minor_unsafe( m_input ) == 31 ) {
            m_input.bump_in_this_line( 1 );
            return state_t();
         }
   ...
   private:
      ...
      {
         IF_( json::internal::peek_uint8( m_input ) != 0xff ) {
